...
if st.button("Show Recommend"):
    ...
    with col1:
        st.text(movie_name[0]); st.image(movie_poster[0])
    with col2:
        st.text(movie_name[1]); st.image(movie_poster[1])
    with col3:
        st.text(movie_name[2]); st.image(movie_poster[2])
    with col4:
        st.text(movie_name[3]); st.image(movie_poster[3])
    with col5:
        st.text(movie_name[4]); st.image(movie_poster[4])
